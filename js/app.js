(() => {
    ...
    function initSliders() {
        if (document.querySelector(".auctions__slider")) new swiper_core_Swiper(".auctions__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".auctions__controlls .controlls__arrow--prev",
                nextEl: ".auctions__controlls .controlls__arrow--next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".collections__slider")) new swiper_core_Swiper(".collections__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".collections__controlls .controlls__arrow--prev",
                nextEl: ".collections__controlls .controlls__arrow--next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".categories__slider")) new swiper_core_Swiper(".categories__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".categories__controlls .controlls__arrow--prev",
                nextEl: ".categories__controlls .controlls__arrow--next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
